...
{
  "items": [
    { "product_code": 29, "current_stock": 5, "last_cycle_consumption": 49, "predicted_consumption": 17.8, "recommended_qty": 17, "purchase_needed": true, "next_order_date": "2026-07-30" }
  ]
}
```
